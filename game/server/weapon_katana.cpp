...
//
// Purpose:		Katana for MCM4 - Nothin personnel, kid
//
// $NoKeywords: $
//=============================================================================//
...
ConVar    sk_plr_dmg_katana		( "sk_plr_dmg_katana","12");
ConVar    sk_npc_dmg_katana		( "sk_npc_dmg_katana","20");
...
{
	{ ACT_MELEE_ATTACK1,	ACT_MELEE_ATTACK_SWING, false },
...
//	if ( pOwner->IsNPC() )
//	{
//		pNPC->CapabilitiesAdd( bits_CAP_MOVE_JUMP | bits_CAP_MOVE_CLIMB );
//	}
}
...
//-----------------------------------------------------------------------------
// Attempt to lead the target (needed because citizens can't hit manhacks with the katana!)
//-----------------------------------------------------------------------------
ConVar sk_katana_lead_time( "sk_katana_lead_time", "0.9" );

int CWeaponKatana::WeaponMeleeAttack1Condition( float flDot, float flDist )
{
	// Attempt to lead the target (needed because citizens can't hit manhacks with the katana!)
	CAI_BaseNPC *pNPC	= GetOwner()->MyNPCPointer();
	...
	float dt = sk_katana_lead_time.GetFloat();
...
void CWeaponKatana::HandleAnimEventMeleeHit( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	...
	CBaseEntity *pHurt = pOperator->CheckTraceHullAttack( pOperator->Weapon_ShootPosition(), vecEnd, 
		Vector(-16,-16,-16), Vector(36,36,36), sk_npc_dmg_katana.GetFloat(), DMG_SLASH, 0.75 );
