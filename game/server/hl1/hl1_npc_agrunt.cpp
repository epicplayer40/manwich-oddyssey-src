...
ConVar sk_agrunt_health( "sk_agrunt_health", "300" );
...
int CNPC_AlienGrunt::IRelationPriority( CBaseEntity *pTarget )
{
	...
	if ( pTarget->Classify() == CLASS_CONSCRIPT )
	{
...
void CNPC_AlienGrunt::Spawn()
{
	...
	CapabilitiesClear();
	CapabilitiesAdd ( bits_CAP_SQUAD | bits_CAP_MOVE_GROUND | bits_CAP_DOORS_GROUP );
