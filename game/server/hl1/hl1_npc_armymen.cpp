...
ConVar	sk_armymen_health( "sk_armymen_health","40");
...
extern int ACT_RANGE_ATTACK1_OTHER;
extern int ACT_WALK_UNARMED;
extern int ACT_RUN_UNARMED;
//---------------------------------------------------------
// Save/Restore
//---------------------------------------------------------
...
bool CNPC_ArmyMen::IsJumpLegal(const Vector &startPos, const Vector &apex, const Vector &endPos) const
{
...
void CNPC_ArmyMen::Spawn()
{
	...
	AddSpawnFlags(SF_START_WITH_GUN_DRAWN);
	...
	m_iHealth			= sk_armymen_health.GetFloat();
...
void CNPC_ArmyMen::ModifyOrAppendCriteria( AI_CriteriaSet& criteriaSet )
{
...
//=========================================================
void CNPC_ArmyMen::AlertSound( void )
{
	if ( GetEnemy() != NULL )
	{
	//	if ( IsOkToSpeak() )
...
//=========================================================
void CNPC_ArmyMen::SetYawSpeed ( void )
{
	int ys;
...
// CheckRangeAttack1
//=========================================================
bool CNPC_ArmyMen::CheckRangeAttack1 ( float flDot, float flDist )
{
...
//=========================================================
void CNPC_ArmyMen::BarneyFirePistol ( void )
{
...
void CNPC_ArmyMen::BarneyFireShotgun ( void )
{
	Vector vecShootOrigin;
...
void CNPC_ArmyMen::BarneyFireGarand ( void )
{
	Vector vecShootOrigin;
...
void CNPC_ArmyMen::DoMuzzleFlash( void )
{
...
void CNPC_ArmyMen::SUB_StartLVFadeOut( float delay, bool notSolid )
{
	SetThink( &CNPC_ArmyMen::SUB_LVFadeOut );
...
void CNPC_ArmyMen::SUB_LVFadeOut( void  )
{
...
void CNPC_ArmyMen::RemoveIgnoredConditions( void )
{
...
void CNPC_ArmyMen::DeclineFollowing( void )
{
...
bool CNPC_ArmyMen::CanBecomeRagdoll( void )
{
	if ( UTIL_IsLowViolence() )
	{
		return false;
...
bool CNPC_ArmyMen::CorpseGib( const CTakeDamageInfo &info )
{
	CEffectData	data;
...
AI_BEGIN_CUSTOM_NPC( monster_barney, CNPC_ArmyMen )
