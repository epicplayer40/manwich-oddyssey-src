...
void CZombie::Precache( void )
{
	...
	PrecacheModel( "models/hombie/classic.mdl" );
	PrecacheModel( "models/hombie/fatssic.mdl" );
	PrecacheModel( "models/zombie/classic_wasteland.mdl" );
...
void CZombie::SetZombieModel( void )
{
	...
	else
	{
		...
		{
			SetModel( "models/hombie/classic.mdl" );
		}
		else if (r == 3)
		{
			SetModel( "models/hombie/fatssic.mdl" );
		}
	//	SetModel( "models/zombie/classic.mdl" );
