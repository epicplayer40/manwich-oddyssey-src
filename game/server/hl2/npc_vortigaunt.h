...
//	>> CNPC_Vortigaunt06
//=========================================================
class CNPC_Vortigaunt06 : public CNPCSimpleTalker
{
	DECLARE_CLASS( CNPC_Vortigaunt06, CNPCSimpleTalker );
...
private:
	...
	enum
	{
		SCHED_VORTSLAVE_STAND = BaseClass::NEXT_SCHEDULE,
	...
	enum 
	{
		TASK_VORTSLAVE_HEAL_WARMUP = BaseClass::NEXT_TASK,
		TASK_VORTSLAVE_HEAL,
		TASK_VORTSLAVE_FACE_STOMP,
		TASK_VORTSLAVE_STOMP_ATTACK,
		TASK_VORTSLAVE_GRENADE_KILL,
		TASK_VORTSLAVE_ZAP_GRENADE_OWNER,
		TASK_VORTSLAVE_EXTRACT_WARMUP,
		TASK_VORTSLAVE_EXTRACT,
		TASK_VORTSLAVE_EXTRACT_COOLDOWN,
		TASK_VORTSLAVE_FIRE_EXTRACT_OUTPUT,
		TASK_VORTSLAVE_WAIT_FOR_PLAYER,
		TASK_VORTSLAVE_GET_HEAL_TARGET,
	};
	...
	enum
	{
		COND_VORTSLAVE_CAN_HEAL = BaseClass::NEXT_CONDITION,
	};
