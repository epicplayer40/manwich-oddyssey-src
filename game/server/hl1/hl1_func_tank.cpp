...
LINK_ENTITY_TO_CLASS( func_tankhl1, CFuncTankGun );
...
LINK_ENTITY_TO_CLASS( func_tankpulselaserhl1, CFuncTankPulseLaser );
...
LINK_ENTITY_TO_CLASS( func_tanklaserhl1, CFuncTankLaser );
...
LINK_ENTITY_TO_CLASS( func_tankrockethl1, CFuncTankRocket );
...
LINK_ENTITY_TO_CLASS( func_tankmortarhl1, CFuncTankMortar );
...
LINK_ENTITY_TO_CLASS( func_tankphyscannisterhl1, CFuncTankPhysCannister );
