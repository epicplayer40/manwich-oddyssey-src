...
//-----------------------------------------------------------------------------
#define COMBOT_CIT_INSPECT_DELAY		1		// Check for citizens this often
#define	COMBOT_CIT_INSPECT_GROUND_DIST	500		// How far to look for citizens to inspect
#define	COMBOT_CIT_INSPECT_FLY_DIST	1500	// How far to look for citizens to inspect

#define COMBOT_CIT_INSPECT_LENGTH		15		// How long does the inspection last
#define COMBOT_HINT_INSPECT_LENGTH		15		// How long does the inspection last
#define COMBOT_SOUND_INSPECT_LENGTH	10		// How long does the inspection last

#define COMBOT_HINT_INSPECT_DELAY		20		// Check for hint nodes this often
	
#define	COMBOT_BANK_RATE				15
#define	COMBOT_MAX_SPEED				400
#define COMBOT_SQUAD_FLY_DIST			500		// How far to scanners stay apart
#define COMBOT_SQUAD_HELP_DIST			4000	// How far will I fly to help

#define COMBOT_SPOTLIGHT_NEAR_DIST		200
#define COMBOT_SPOTLIGHT_FAR_DIST		300
#define COMBOT_SPOTLIGHT_FLY_HEIGHT	200
#define COMBOT_NOSPOTLIGHT_FLY_HEIGHT	60

#define COMBOT_GAS_DAMAGE_DIST			500
#define COMBOT_FLASH_MIN_DIST			900		// How far does flash effect enemy
#define COMBOT_FLASH_MAX_DIST			1200	// How far does flash effect enemy
#define	COMBOT_FLASH_MAX_VALUE			240		// How bright is maximum flash

#define COMBOT_PHOTO_NEAR_DIST			120
#define COMBOT_PHOTO_FAR_DIST			180

#define COMBOT_ATTACK_NEAR_DIST		150		// Fly attack min distance
#define COMBOT_ATTACK_FAR_DIST			300		// Fly attack max distance
#define COMBOT_ATTACK_RANGE			350		// Attack max distance
#define	COMBOT_ATTACK_MIN_DELAY		2		// Min time between attacks
#define	COMBOT_ATTACK_MAX_DELAY		4		// Max time between attacks
#define	COMBOT_EVADE_TIME				1		// How long to evade after take damage

#define	COMBOT_NUM_GIBS				6		// Number of gibs in gib file

//------------------------------------
// Spawnflags
//------------------------------------
#define SF_COMBOT_NO_DYNAMIC_LIGHT	(1 << 16)


ConVar	sk_combot_health( "sk_combot_health","0");
ConVar	sk_combot_dmg_gas( "sk_combot_dmg_gas","0");
ConVar	sk_combot_dmg_dive( "sk_combot_dmg_dive","0");

//-----------------------------------------------------------------------------
// Private activities.
//-----------------------------------------------------------------------------
static int ACT_COMBOT_SMALL_FLINCH_ALERT = 0;
static int ACT_COMBOT_SMALL_FLINCH_COMBAT = 0;
static int ACT_COMBOT_IDLE_ALERT = 0;
static int ACT_COMBOT_INSPECT = 0;
static int ACT_COMBOT_WALK_ALERT = 0;
static int ACT_COMBOT_WALK_COMBAT = 0;
static int ACT_COMBOT_FLARE = 0;
static int ACT_COMBOT_RETRACT = 0;
static int ACT_COMBOT_FLARE_PRONGS = 0;
static int ACT_COMBOT_RETRACT_PRONGS = 0;
...
enum
{
	COND_COMBOT_FLY_CLEAR = LAST_SHARED_CONDITION,
	COND_COMBOT_FLY_BLOCKED,							
	COND_COMBOT_HAVE_INSPECT_TARGET,							
	COND_COMBOT_INSPECT_DONE,							
	COND_COMBOT_CAN_PHOTOGRAPH,
	COND_COMBOT_SPOT_ON_TARGET,
};
...
enum
{
	SCHED_COMBOT_PATROL = LAST_SHARED_SCHEDULE,
	SCHED_COMBOT_SPOTLIGHT_HOVER,
	SCHED_COMBOT_SPOTLIGHT_INSPECT_POS,
	SCHED_COMBOT_SPOTLIGHT_INSPECT_CIT,
	SCHED_COMBOT_PHOTOGRAPH_HOVER,
	SCHED_COMBOT_PHOTOGRAPH,
	SCHED_COMBOT_ATTACK_HOVER,
	SCHED_COMBOT_ATTACK_FLASH,
	SCHED_COMBOT_ATTACK_GAS,
	SCHED_COMBOT_ATTACK_DIVEBOMB,
	SCHED_COMBOT_CHASE_ENEMY,
	SCHED_COMBOT_CHASE_TARGET,
};
...
enum
{
	TASK_COMBOT_SET_FLY_PHOTO = LAST_SHARED_TASK,
	TASK_COMBOT_SET_FLY_PATROL,
	TASK_COMBOT_SET_FLY_CHASE,
	TASK_COMBOT_SET_FLY_SPOT,
	TASK_COMBOT_SET_FLY_ATTACK,
	TASK_COMBOT_SET_FLY_DIVE,
	TASK_COMBOT_PHOTOGRAPH,
	TASK_COMBOT_ATTACK_PRE_FLASH,
	TASK_COMBOT_ATTACK_FLASH,
	TASK_COMBOT_ATTACK_PRE_GAS,
	TASK_COMBOT_ATTACK_GAS,
	TASK_COMBOT_SPOT_INSPECT_ON,
	TASK_COMBOT_SPOT_INSPECT_WAIT,
	TASK_COMBOT_SPOT_INSPECT_OFF,
	TASK_COMBOT_CLEAR_INSPECT_TARGET,
};
...
// Interactions
//-----------------------------------------------------------------------------
int	g_interactionCombotInspect				= 0;
int	g_interactionCombotInspectBegin		= 0;
int g_interactionCombotInspectHandsUp		= 0;
int g_interactionCombotInspectShowArmband	= 0;//<<TEMP>>still to be completed
int	g_interactionCombotInspectDone			= 0;
int g_interactionCombotSupportEntity		= 0;
int g_interactionCombotSupportPosition		= 0;


//-----------------------------------------------------------------------------
// Attachment points.
//-----------------------------------------------------------------------------
#define COMBOT_ATTACHMENT_LIGHT		0
#define COMBOT_ATTACHMENT_FLASH		1
#define COMBOT_ATTACHMENT_LPRONG	2
#define COMBOT_ATTACHMENT_RPRONG	3


//-----------------------------------------------------------------------------
// Other defines.
//-----------------------------------------------------------------------------
#define COMBOT_MAX_BEAMS		4
...
{
	COMBOT_FLY_PHOTO = 0,		// Fly close to photograph entity
	COMBOT_FLY_PATROL,			// Fly slowly around the enviroment
	COMBOT_FLY_CHASE,			// Fly quickly around the enviroment
	COMBOT_FLY_SPOT,			// Fly above enity in spotlight position
	COMBOT_FLY_ATTACK,			// Get in my enemies face for spray or flash
	COMBOT_FLY_DIVE,			// Divebomb - only done when dead
};

enum ScannerInspectAct_t
{
	COMBOT_INSACT_HANDS_UP,
	COMBOT_INSACT_SHOWARMBAND,
};
...
class CNPC_Combot : public CAI_BaseFlyingBot
{
DECLARE_CLASS( CNPC_Combot, CAI_BaseFlyingBot );
...
BEGIN_DATADESC( CNPC_Combot )

	DEFINE_EMBEDDED( m_KilledInfo ),
	DEFINE_FIELD( m_vecAccelMin,				FIELD_VECTOR ),
	DEFINE_FIELD( m_vecAccelMax,				FIELD_VECTOR ),
	DEFINE_FIELD( m_flFlightSpeed,			FIELD_FLOAT ),
	DEFINE_FIELD( m_flStoppingDistance,		FIELD_FLOAT ),
...
LINK_ENTITY_TO_CLASS(npc_combot, CNPC_Combot);

CNPC_Combot::CNPC_Combot()
{
#ifdef _DEBUG
	m_vInspectPos.Init();
...
//-----------------------------------------------------------------------------
Class_T	CNPC_Combot::Classify(void)
{
...
// Output  :
//------------------------------------------------------------------------------
int CNPC_Combot::GetSoundInterests( void )
{
...
// Output  :
//------------------------------------------------------------------------------
int CNPC_Combot::OnTakeDamage_Alive( const CTakeDamageInfo &info )
{
...
// Output  :
//------------------------------------------------------------------------------
int CNPC_Combot::OnTakeDamage_Dying( const CTakeDamageInfo &info )
{
	// do the damage
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Combot::TraceAttack( const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
...
void CNPC_Combot::Gib(void)
{
	...
	CGib::SpawnSpecificGibs( this, COMBOT_NUM_GIBS, 300, 400, "models/gibs/combot_gibs.mdl");
...
// Purpose:
//------------------------------------------------------------------------------
void CNPC_Combot::StopLoopingSounds(void)
{
...
//			bitsDamageType - 
//-----------------------------------------------------------------------------
void CNPC_Combot::Event_Killed( const CTakeDamageInfo &info )
{
...
// Purpose:
//------------------------------------------------------------------------------
void CNPC_Combot::AttackDivebombCollide(float flInterval)
{
	// ----------------------------------------
	...
	if (tr.m_pEnt)
	{
		...
		{
			CTakeDamageInfo info( this, this, sk_combot_dmg_dive.GetFloat(), DMG_CLUB );
	...
	if (tr.fraction != 1.0)
	{
		...
		if (pBCC)
		{
			...
			SpawnBlood(tr.endpos, g_vecAttackDir, pBCC->BloodColor(), sk_combot_dmg_dive.GetFloat());
		}
		else
		{
...
//-----------------------------------------------------------------------------
bool CNPC_Combot::FValidateHintType(CAI_Hint *pHint)
{
...
// Input  : Type - 
//-----------------------------------------------------------------------------
int CNPC_Combot::TranslateSchedule( int scheduleType ) 
{
	switch ( scheduleType )
	{
		case SCHED_IDLE_STAND:
		{
			return SCHED_COMBOT_PATROL;
		}
	}
...
//-----------------------------------------------------------------------------
void CNPC_Combot::AlertSound(void)
{
...
// Purpose:
//------------------------------------------------------------------------------
void CNPC_Combot::DeathSound(void)
{
...
//-----------------------------------------------------------------------------
void CNPC_Combot::IdleSound(void)
{
...
//-----------------------------------------------------------------------------
void CNPC_Combot::PainSound(void)
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CNPC_Combot::PlayFlySound(void)
{
	...
	float	flVolume = 0.25f + (0.75f*(speed/COMBOT_MAX_SPEED));
	int		iPitch	 = 80 + (20*(speed/COMBOT_MAX_SPEED));
...
//-----------------------------------------------------------------------------
void CNPC_Combot::NPCThink(void)
{
	if (!IsAlive())
	{
		SetActivity((Activity)ACT_COMBOT_RETRACT_PRONGS);
		StudioFrameAdvance( );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Combot::Precache(void)
{
	//
	// Model.
	//
...
// Output  :
//------------------------------------------------------------------------------
#define COMBOT_SENTENCE_ATTENTION	0
#define COMBOT_SENTENCE_HANDSUP	1
#define COMBOT_SENTENCE_PROCEED	2
#define COMBOT_SENTENCE_CURIOUS	3
void CNPC_Combot::SpeakSentence( int sentenceType )
{
	

	if		(sentenceType == COMBOT_SENTENCE_ATTENTION)
	{
		EmitSound( "NPC_CScanner.Attention" );
	}
	else if (sentenceType == COMBOT_SENTENCE_HANDSUP)
	{
		EmitSound( "NPC_CScanner.Scan" );
	}
	else if (sentenceType == COMBOT_SENTENCE_PROCEED)
	{
		EmitSound( "NPC_CScanner.Proceed" );
	}
	else if (sentenceType == COMBOT_SENTENCE_CURIOUS)
	{
...
//------------------------------------------------------------------------------
void CNPC_Combot::RequestInspectSupport(void)
{
	if (m_pSquad)
	{
		AISquadIter_t iter;
		for (CAI_BaseNPC *pSquadMember = m_pSquad->GetFirstMember( &iter ); pSquadMember; pSquadMember = m_pSquad->GetNextMember( &iter ) )
		{
			if (pSquadMember != this)
			{
				if (GetTarget())
				{
					pSquadMember->HandleInteraction(g_interactionCombotSupportEntity,((void *)((CBaseEntity*)GetTarget())),this);
				}
				else
				{
					pSquadMember->HandleInteraction(g_interactionCombotSupportPosition,((void *)m_vInspectPos.Base()),this);
				}
			}
		}
	}
...
// Purpose:
//------------------------------------------------------------------------------
bool CNPC_Combot::IsValidInspectTarget(CBaseEntity *pEntity)
{
...
// Purpose:
//------------------------------------------------------------------------------
CBaseEntity* CNPC_Combot::BestInspectTarget(void)
{
	...
	if (m_pSpotlightTarget != NULL)
	{
		...
		fSearchDist		= COMBOT_CIT_INSPECT_GROUND_DIST;
	}
	else
	{
		vSearchOrigin	= GetLocalOrigin();
		fSearchDist		= COMBOT_CIT_INSPECT_FLY_DIST;
	}
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::SetInspectTargetToEnt(CBaseEntity *pEntity, float fInspectDuration)
{
	ClearInspectTarget();
	SetTarget(pEntity);
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::SetInspectTargetToHint(CAI_Hint *pHint, float fInspectDuration)
{
	ClearInspectTarget();
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::SetInspectTargetToPos(const Vector &vInspectPos, float fInspectDuration)
{
	ClearInspectTarget();
...
//------------------------------------------------------------------------------
void CNPC_Combot::ClearInspectTarget(void)
{
	// Unlock hint node
	if (m_pHintNode)
	{
		m_pHintNode->Unlock(COMBOT_HINT_INSPECT_LENGTH);
	}
...
//------------------------------------------------------------------------------
bool CNPC_Combot::HaveInspectTarget(void)
{
	if (GetTarget() != NULL)
	{
		return true;
...
// Purpose: 
//------------------------------------------------------------------------------
Vector CNPC_Combot::InspectTargetPosition(void)
{
	if (GetTarget() != NULL)
	{
		// If in spotlight mode, aim for ground below target unless is client
		if (m_nFlyMode	== COMBOT_FLY_SPOT && !(GetTarget()->GetFlags() & FL_CLIENT))
		{
			Vector vInspectPos;
...
//-----------------------------------------------------------------------------
void CNPC_Combot::InputInspectTargetPhoto(inputdata_t &inputdata)
{
	InspectTarget(inputdata, COMBOT_FLY_PHOTO);
}
...
// Input  : String name or classname of the entity to inspect.
//-----------------------------------------------------------------------------
void CNPC_Combot::InputInspectTargetSpotlight(inputdata_t &inputdata)
{
	InspectTarget(inputdata, COMBOT_FLY_SPOT);
}
...
// Input  : String name or classname of the entity to inspect.
//-----------------------------------------------------------------------------
void CNPC_Combot::InspectTarget(inputdata_t &inputdata, ScannerFlyMode_t eFlyMode)
{
	CBaseEntity *pEnt = gEntList.FindEntityGeneric(NULL, inputdata.value.String(), this, inputdata.pActivator);
	if (pEnt != NULL)
	{
		SetInspectTargetToEnt(pEnt, COMBOT_CIT_INSPECT_LENGTH);
		m_nFlyMode = eFlyMode;
		SetCondition(COND_COMBOT_HAVE_INSPECT_TARGET);
	}
	else
	{
		if (pEnt == NULL)
...
// Purpose:
//------------------------------------------------------------------------------
void CNPC_Combot::PrescheduleThink(void)
{
	...
	// ---------------------------------------------------------
	ClearCondition ( COND_COMBOT_INSPECT_DONE );

	if (HaveInspectTarget() &&
		gpGlobals->curtime > m_fInspectEndTime)
	{
		SetCondition ( COND_COMBOT_INSPECT_DONE );

		m_fCheckCitizenTime	= gpGlobals->curtime + COMBOT_CIT_INSPECT_DELAY;
		m_fCheckHintTime	= gpGlobals->curtime + COMBOT_HINT_INSPECT_DELAY;
		ClearInspectTarget();
	}
		...
		HasCondition(COND_HEAR_DANGER)) )
	{
		...
		if (pSound)
		{
			...
			SetInspectTargetToPos(vSoundPos,COMBOT_SOUND_INSPECT_LENGTH);

			m_nFlyMode = (random->RandomInt(0,1)==0) ? COMBOT_FLY_SPOT : COMBOT_FLY_PHOTO;
		}
	}
	...
	// ---------------------------------------------------------
	ClearCondition ( COND_COMBOT_HAVE_INSPECT_TARGET );
		...
		!HaveInspectTarget()							)
	{
		...
		if (pBestEntity)
		{
			...
			if (pNPC && pNPC->HandleInteraction(g_interactionCombotInspect,NULL,this))
			{
				SetInspectTargetToEnt(pBestEntity,COMBOT_CIT_INSPECT_LENGTH);
				m_nFlyMode = (random->RandomInt(0,1)==0) ? COMBOT_FLY_SPOT : COMBOT_FLY_PHOTO;
				SetCondition ( COND_COMBOT_HAVE_INSPECT_TARGET );
			}
		}
	...
	if (GetEnemy()			==	NULL				&&
		...
		!HaveInspectTarget()						)
	{
	//	m_pHintNode = CAI_Hint::FindHint( this, HINT_NONE, 0, COMBOT_CIT_INSPECT_FLY_DIST );

	//	if (m_pHintNode)
	//	{
			m_fCheckHintTime	= gpGlobals->curtime + COMBOT_HINT_INSPECT_DELAY;

			m_nFlyMode = (random->RandomInt(0,2)==0) ? COMBOT_FLY_SPOT : COMBOT_FLY_PHOTO;

			SetInspectTargetToHint(m_pHintNode,COMBOT_HINT_INSPECT_LENGTH);
	...
	// --------------------------------------
	ClearCondition( COND_COMBOT_SPOT_ON_TARGET );
		 ...
		 m_pSpotlightTarget->GetAbsVelocity().Length() < 25 )
	{
		...
		if (GetTarget())
		{
			...
			if (fInspectDist < 100  )
			{
				SetCondition( COND_COMBOT_SPOT_ON_TARGET );
			}
		}
	...
	// --------------------------------------------
	ClearCondition(COND_COMBOT_CAN_PHOTOGRAPH);

	if (m_nFlyMode ==  COMBOT_FLY_PHOTO)
	{
			...
			GetCurrentVelocity().Length()	<	100					)
		{
			...
			if (fInspectDist > COMBOT_PHOTO_NEAR_DIST &&
				fInspectDist < COMBOT_PHOTO_FAR_DIST )
			{
				trace_t tr;
				...
				if (tr.fraction == 1.0)
				{
					SetCondition(COND_COMBOT_CAN_PHOTOGRAPH);
				}
			}
		}
	}
...
// Output :
//-----------------------------------------------------------------------------
int CNPC_Combot::MeleeAttack1Conditions ( float flDot, float flDist )
{
	if (GetEnemy() == NULL)
	{
		return COND_NONE;
	...
	else if (vEnemyDist2D > COMBOT_ATTACK_RANGE)
	{
...
//-----------------------------------------------------------------------------
Disposition_t CNPC_Combot::IRelationType(CBaseEntity *pTarget)
{
	//
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CNPC_Combot::RunTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
		case TASK_COMBOT_PHOTOGRAPH:
		{
		...
		case TASK_COMBOT_ATTACK_PRE_FLASH:
		{
			AttackPreFlash();
			if (gpGlobals->curtime > m_flWaitFinished)
			{
		...
		case TASK_COMBOT_ATTACK_PRE_GAS:
		{
			if (gpGlobals->curtime > m_flWaitFinished)
			{
...
//			bits.
//-----------------------------------------------------------------------------
int CNPC_Combot::SelectSchedule(void)
{
	//
	...
	if (m_iHealth < 0)
	{
		return SCHED_COMBOT_ATTACK_DIVEBOMB;
	}
		 ...
		 HasCondition(COND_HEAVY_DAMAGE) )
	{
		...
		{
			if ( m_iHealth < ( 3 * sk_combot_health.GetFloat() / 4 ))
			{
		...
		GetEnemy()->IsAlive()	)
	{
		...
		else if (HasCondition( COND_COMBOT_FLY_BLOCKED ))
		{  
			return SCHED_COMBOT_CHASE_ENEMY;
		}
		else if (gpGlobals->curtime < m_flNextAttack)
		{
			return SCHED_COMBOT_SPOTLIGHT_HOVER;
		}
		else
		{
			...
			{ 
				...
				{
					return SCHED_COMBOT_ATTACK_FLASH;
				}
				else
				{
					return SCHED_COMBOT_ATTACK_GAS;
				}
			}
			else
			{
				...
				if (fAttack2DDist > COMBOT_ATTACK_FAR_DIST)
				{
					return SCHED_COMBOT_SPOTLIGHT_HOVER;
				}
				// ----------------------------------------
				...
				{
					return SCHED_COMBOT_ATTACK_HOVER;
				}
			}
		}
	}
	...
	if (HaveInspectTarget())
	{
		if (HasCondition( COND_COMBOT_FLY_BLOCKED ))
		{  
			return SCHED_COMBOT_CHASE_TARGET;
		}

		// If I was chasing, pick with photographing or spotlighting 
		if (m_nFlyMode == COMBOT_FLY_CHASE)
		{
			m_nFlyMode = (random->RandomInt(0,1)==0) ? COMBOT_FLY_SPOT : COMBOT_FLY_PHOTO;
		}

		if (m_nFlyMode == COMBOT_FLY_SPOT)
		{
			if (HasCondition( COND_COMBOT_SPOT_ON_TARGET ))
			{
				if (GetTarget())
				{
					...
					{
						return SCHED_COMBOT_SPOTLIGHT_INSPECT_CIT;
					}
				...
				{
					return SCHED_COMBOT_SPOTLIGHT_INSPECT_POS;
				}
			}
			else
			{
		...
		else if (m_nFlyMode == COMBOT_FLY_PHOTO)
		{
			if ( HasCondition( COND_COMBOT_CAN_PHOTOGRAPH ))
			{ 
				return SCHED_COMBOT_PHOTOGRAPH;
			}
			else
			{			
				return SCHED_COMBOT_PHOTOGRAPH_HOVER;
			}
		}
		else if (m_nFlyMode == COMBOT_FLY_PATROL)
		{
			return SCHED_COMBOT_PATROL;
		}
	}
...
// Purpose:
//------------------------------------------------------------------------------
void CNPC_Combot::SpotlightDestroy(void)
{
	if (m_pSpotlight)
	{
...
// Purpose:
//------------------------------------------------------------------------------
void CNPC_Combot::SpotlightCreate(void)
{
	// -------------------------------------------------
...
//	UTIL_Relink(m_pSpotlightTarget);
	...
	// attach to light
	m_pSpotlight->SetStartAttachment( COMBOT_ATTACHMENT_LIGHT );
...
// Purpose:
//------------------------------------------------------------------------------
Vector CNPC_Combot::SpotlightTargetPos(void)
{
	// ----------------------------------------------
	//  If I have an enemy 
	// ----------------------------------------------
...
// Purpose:
//------------------------------------------------------------------------------
Vector CNPC_Combot::SpotlightCurrentPos(void)
{
	Vector vTargetDir		= SpotlightTargetPos() - GetLocalOrigin();
	VectorNormalize(vTargetDir);
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::SpotlightUpdate(void)
{
	//FIXME: JDW - E3 Hack
	if ( m_bNoLight )
	{
	...
	if ( FBitSet (m_spawnflags, SF_COMBOT_NO_DYNAMIC_LIGHT) )
	{
...
void CNPC_Combot::Spawn(void)
{
	...
	m_iHealth			= sk_combot_health.GetFloat();
	...
	m_pEyeFlash->SetAttachment( this, COMBOT_ATTACHMENT_LIGHT + 1 );
	m_pEyeFlash->SetBrightness( 0 );
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::TakePhoto(void)
{
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::AttackPreFlash(void)
{
	EmitSound( "NPC_CScanner.TakePhoto" );
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::AttackPreGas(void)
{
	EmitSound( "NPC_CScanner.TakePhoto" );
	m_pEyeFlash->SetScale( .0 );
	m_pEyeFlash->SetBrightness( 255 );
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::AttackFlash(void)
{
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::AttackFlashBlind(void)
{
	if( GetEnemy() )
	{
	...
	float fAttackDelay = random->RandomFloat(COMBOT_ATTACK_MIN_DELAY,COMBOT_ATTACK_MAX_DELAY);
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::AttackGas(void)
{
	if (GetEnemy())
	{
	...
	//	pJet->m_Color		= Vector(110/255.0,82/255.0,9/255.0); // Mustard gas orange
		...
		float fAttackDelay		= random->RandomInt(COMBOT_ATTACK_MIN_DELAY,COMBOT_ATTACK_MAX_DELAY);
		m_flNextAttack			= gpGlobals->curtime + fAttackDelay;
		m_fNextSpotlightTime	= gpGlobals->curtime + 1.0;
	}
}
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::AttackGasDamage(void)
{
	...
	if (fEnemyDist > COMBOT_GAS_DAMAGE_DIST)
	{
		return;
	}
	...
	if (dotPr > 0.90)
	{
		GetEnemy()->TakeDamage( CTakeDamageInfo( this, this, sk_combot_dmg_gas.GetFloat(), DMG_NERVEGAS ) );
	}
...
// Output  :
//------------------------------------------------------------------------------
void CNPC_Combot::AttackDivebomb(void)
{
...
void CNPC_Combot::BlindFlashTarget( CBaseEntity *pTarget )
{
...
//	int 			nAIs 	= g_AI_Manager.NumAIs();
	...
	if ( dotPr > 0.5f )
	{
		...
		{
			color32 white = { 255, 255, 255, COMBOT_FLASH_MAX_VALUE * dotPr };
...
// Input  : pTask - 
//-----------------------------------------------------------------------------
void CNPC_Combot::StartTask( const Task_t *pTask )
{
	switch (pTask->iTask)
	{
		case TASK_COMBOT_SPOT_INSPECT_ON:
		{
			if (GetTarget() == NULL)
			{
			...
			else
			{
				...
				{
					pNPC->HandleInteraction(g_interactionCombotInspectBegin,NULL,this);
					
					// Now we need some time to inspect
					m_fInspectEndTime = gpGlobals->curtime + COMBOT_CIT_INSPECT_LENGTH;
					TaskComplete();
				}
			}
			break;
		}
		case TASK_COMBOT_SPOT_INSPECT_WAIT:
		{
			if (GetTarget() == NULL)
			{
				TaskFail(FAIL_NO_TARGET);
			...
			else
			{
				...
				else
				{
					...
					pNPC->HandleInteraction(g_interactionCombotInspectHandsUp,NULL,this);
				}
				TaskComplete();
			}
			break;
		}
		case TASK_COMBOT_SPOT_INSPECT_OFF:
		{
			if (GetTarget() == NULL)
			{
				TaskFail(FAIL_NO_TARGET);
			...
			else
			{
				...
				{
					pNPC->HandleInteraction(g_interactionCombotInspectDone,NULL,this);
		...
		case TASK_COMBOT_CLEAR_INSPECT_TARGET:
		{
			ClearInspectTarget();
		}
		case TASK_COMBOT_SET_FLY_PHOTO:
		{
			m_nFlyMode = COMBOT_FLY_PHOTO;
		...
		case TASK_COMBOT_SET_FLY_PATROL:
		{
		...
		case TASK_COMBOT_SET_FLY_CHASE:
		{
			m_nFlyMode = COMBOT_FLY_CHASE;
			TaskComplete();
			break;
		}
		case TASK_COMBOT_SET_FLY_SPOT:
		{
			m_nFlyMode = COMBOT_FLY_SPOT;
			TaskComplete();
			break;
		}
		case TASK_COMBOT_SET_FLY_ATTACK:
		{
			m_nFlyMode = COMBOT_FLY_ATTACK;
			TaskComplete();
			break;
		}
		case TASK_COMBOT_SET_FLY_DIVE:
		{
			m_nFlyMode = COMBOT_FLY_DIVE;
			TaskComplete();
			break;
		}
...
void CNPC_Combot::OnScheduleChange( void )
{
	m_flSpeed = COMBOT_MAX_SPEED;
...
//-----------------------------------------------------------------------------
bool CNPC_Combot::ShouldPlayIdleSound( void )
{
...
// Output  :
//------------------------------------------------------------------------------
float CNPC_Combot::MinGroundDist(void)
{
	if (m_nFlyMode	== COMBOT_FLY_SPOT && !m_pHintNode)
	{
		return COMBOT_SPOTLIGHT_FLY_HEIGHT;
	}
	else
	{
		return COMBOT_NOSPOTLIGHT_FLY_HEIGHT;
	}
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CNPC_Combot::SetBanking(float flInterval)
{
	...
	while (timeToUse > 0)
	{
		...
		vFlyDirection *= COMBOT_BANK_RATE;

		Vector vBankDir;
		
		if (m_nFlyMode == COMBOT_FLY_PATROL && m_pSpotlight)
		{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_Combot::MoveExecute_Alive(float flInterval)
{
...
// Input  : flInterval - 
//-----------------------------------------------------------------------------
bool CNPC_Combot::OverridePathMove( float flInterval )
{
	...
	if ( ProgressFlyPath( flInterval, pMoveTarget, MASK_NPCSOLID,
						  !IsCurSchedule( SCHED_COMBOT_PATROL ), 64 ) == AINPP_COMPLETE )
	{
		if (IsCurSchedule( SCHED_COMBOT_PATROL ))
		{
...
bool CNPC_Combot::OverrideMove(float flInterval)
{
	// ----------------------------------------------
	//	Select move target 
	// ----------------------------------------------
	...
	if (pMoveTarget || HaveInspectTarget())
	{
		...
		if (fTargetDist > 50)
		{
			...
			*/
			...
			SetCondition( COND_COMBOT_FLY_BLOCKED );
		}
		else
		{
			SetCondition( COND_COMBOT_FLY_CLEAR );
		}
	}
	...
	//	If spotlighting
	// ----------------------------------------------
	else if (m_nFlyMode == COMBOT_FLY_SPOT)
	{
	...
	//	If attacking
	// ----------------------------------------------
	else if (m_nFlyMode == COMBOT_FLY_ATTACK)
	{
		if (m_pSpotlight)
		{
			SpotlightDestroy();
	...
	//	If dive bombing
	// ----------------------------------------------
	else if (m_nFlyMode == COMBOT_FLY_DIVE)
	{
		if (m_pSpotlight)
		{
			SpotlightDestroy();
...
//-----------------------------------------------------------------------------
void CNPC_Combot::ClampSteer( Vector &vecSteerAbs, Vector &vecSteerRel, Vector &forward, Vector &right, Vector &up )
{
...
//-----------------------------------------------------------------------------
void CNPC_Combot::SteerSeek(Vector &vecSteer, const Vector &vecTarget)
{
...
//-----------------------------------------------------------------------------
void CNPC_Combot::MoveToTarget( float flInterval, const Vector &vecMoveTarget )
{
	if (m_pSpotlight)
	{
		TurnHeadToTarget(flInterval, m_vSpotlightCurrentPos);
	...
	if (m_nFlyMode == COMBOT_FLY_PATROL  )
	{
		m_flFlightSpeed = 100;
...
// Input  : flInterval - 
//-----------------------------------------------------------------------------
void CNPC_Combot::MoveToSpotlight(float flInterval)
{
	Vector vTargetPos;
	...
	vTargetDir.z = 0;
	VectorNormalize( vTargetDir );
	if (fTargetDist < COMBOT_SPOTLIGHT_NEAR_DIST)
	{
		vFlyDirection = -vTargetDir;
	}
	else if (fTargetDist > COMBOT_SPOTLIGHT_FAR_DIST)
	{
		vFlyDirection = vTargetDir;
	}
		...
		gpGlobals->curtime > m_fInspectEndTime)
	{
		...
		if (pNearest)
		{
			...
			if (vNearestDir.Length() < COMBOT_SQUAD_FLY_DIST) 
			{
	...
	// ---------------------------------------------------------
	if ((m_flLastDamageTime + COMBOT_EVADE_TIME) > gpGlobals->curtime)
	{
...
// Input  : flInterval - 
//-----------------------------------------------------------------------------
void CNPC_Combot::MoveToAttack(float flInterval)
{
	if (GetEnemy() == NULL)
	{
		return;
	...
	if (fAttack2DDist < COMBOT_ATTACK_NEAR_DIST)
	{
		vFlyDirection.x = -vAttackDir.x;
		vFlyDirection.y = -vAttackDir.y;
		vFlyDirection.z = -vAttackDir.z;
	}
	else if (fAttack2DDist > COMBOT_ATTACK_FAR_DIST)
	{
		vFlyDirection.x = vAttackDir.x;
		vFlyDirection.y = vAttackDir.y;
	}
...
// Input  : flInterval - 
//-----------------------------------------------------------------------------
void CNPC_Combot::MoveToDivebomb(float flInterval)
{
	float	myAccel = 800; 
	float	myDecay	 = 0.35; // decay to 35% in 1 second
...
// Purpose:
//-----------------------------------------------------------------------------
void CNPC_Combot::MoveToPhotograph(float flInterval)
{
	if (!HaveInspectTarget())
	{
		return;
...
// Purpose:
//-----------------------------------------------------------------------------
Vector CNPC_Combot::VelocityToEvade(CBaseCombatCharacter *pEnemy)
{
	if (pEnemy)
	{
		// -----------------------------------------
...
//-----------------------------------------------------------------------------
bool CNPC_Combot::HandleInteraction(int interactionType, void *data, CBaseCombatCharacter* pSourceEnt)
{
	//	TODO:: - doing this by just an interrupt contition would be a lot better!
	if (interactionType ==	g_interactionCombotSupportEntity)
	{
		...
		if (GetEnemy() == NULL && !HaveInspectTarget())
		{
			...
			if (fTargetDist < COMBOT_SQUAD_HELP_DIST)
			{
				float fInspectTime = (((CNPC_Combot*)pSourceEnt)->m_fInspectEndTime - gpGlobals->curtime);
				SetInspectTargetToEnt(pTarget,fInspectTime);

				if (random->RandomInt(0,2)==0)
				{
					SetSchedule(SCHED_COMBOT_PHOTOGRAPH_HOVER);
				}
				else
				{
					SetSchedule(SCHED_COMBOT_SPOTLIGHT_HOVER);
				}
				return true;
			}
		}
	}
	else if (interactionType ==	g_interactionCombotSupportPosition)
	{
		// Only accept help request if I'm not already busy
		if (GetEnemy() == NULL && !HaveInspectTarget())
		{
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_Combot::InputDisableSpotlight( inputdata_t &inputdata )
{
	m_bNoLight = true;
}
...
AI_BEGIN_CUSTOM_NPC( npc_cscanner, CNPC_Combot )

	DECLARE_TASK(TASK_COMBOT_SET_FLY_PHOTO)
	DECLARE_TASK(TASK_COMBOT_SET_FLY_PATROL)
	DECLARE_TASK(TASK_COMBOT_SET_FLY_CHASE)
	DECLARE_TASK(TASK_COMBOT_SET_FLY_SPOT)
	DECLARE_TASK(TASK_COMBOT_SET_FLY_ATTACK)
	DECLARE_TASK(TASK_COMBOT_SET_FLY_DIVE)
	DECLARE_TASK(TASK_COMBOT_PHOTOGRAPH)
	DECLARE_TASK(TASK_COMBOT_ATTACK_PRE_FLASH)
	DECLARE_TASK(TASK_COMBOT_ATTACK_FLASH)
	DECLARE_TASK(TASK_COMBOT_ATTACK_PRE_GAS)
	DECLARE_TASK(TASK_COMBOT_ATTACK_GAS)
	DECLARE_TASK(TASK_COMBOT_SPOT_INSPECT_ON)
	DECLARE_TASK(TASK_COMBOT_SPOT_INSPECT_WAIT)
	DECLARE_TASK(TASK_COMBOT_SPOT_INSPECT_OFF)
	DECLARE_TASK(TASK_COMBOT_CLEAR_INSPECT_TARGET)

	DECLARE_CONDITION(COND_COMBOT_FLY_CLEAR)
	DECLARE_CONDITION(COND_COMBOT_FLY_BLOCKED)
	DECLARE_CONDITION(COND_COMBOT_HAVE_INSPECT_TARGET)
	DECLARE_CONDITION(COND_COMBOT_INSPECT_DONE)
	DECLARE_CONDITION(COND_COMBOT_CAN_PHOTOGRAPH)
	DECLARE_CONDITION(COND_COMBOT_SPOT_ON_TARGET)

	DECLARE_ACTIVITY(ACT_COMBOT_SMALL_FLINCH_ALERT)
	DECLARE_ACTIVITY(ACT_COMBOT_SMALL_FLINCH_COMBAT)
	DECLARE_ACTIVITY(ACT_COMBOT_IDLE_ALERT)
	DECLARE_ACTIVITY(ACT_COMBOT_INSPECT)
	DECLARE_ACTIVITY(ACT_COMBOT_WALK_ALERT)
	DECLARE_ACTIVITY(ACT_COMBOT_WALK_COMBAT)
	DECLARE_ACTIVITY(ACT_COMBOT_FLARE)
	DECLARE_ACTIVITY(ACT_COMBOT_RETRACT)
	DECLARE_ACTIVITY(ACT_COMBOT_FLARE_PRONGS)
	DECLARE_ACTIVITY(ACT_COMBOT_RETRACT_PRONGS)

	DECLARE_INTERACTION(g_interactionCombotInspect)
	DECLARE_INTERACTION(g_interactionCombotInspectBegin)
	DECLARE_INTERACTION(g_interactionCombotInspectDone)
	DECLARE_INTERACTION(g_interactionCombotInspectHandsUp)
	DECLARE_INTERACTION(g_interactionCombotInspectShowArmband)
	DECLARE_INTERACTION(g_interactionCombotSupportEntity)
	DECLARE_INTERACTION(g_interactionCombotSupportPosition)
	...
	(
		...
		"	Tasks"
		"		TASK_COMBOT_CLEAR_INSPECT_TARGET	0"
		"		TASK_COMBOT_SET_FLY_PATROL			0"
	...
	(
		...
		"	Tasks"
		"		TASK_COMBOT_SET_FLY_SPOT			0"
		"		TASK_SET_ACTIVITY					ACTIVITY:ACT_COMBOT_INSPECT"
	...
	(
		...
		"		TASK_WAIT							1"
		"		TASK_COMBOT_SPOT_INSPECT_ON		0"
		"		TASK_WAIT							2"
		"		TASK_SPEAK_SENTENCE					1"	// Hands on head or Show Armband!
		"		TASK_WAIT							1"
		"		TASK_COMBOT_SPOT_INSPECT_WAIT		0"
		"		TASK_WAIT							5"
		"		TASK_SPEAK_SENTENCE					2"	// Free to go!
		"		TASK_WAIT							1"
		"		TASK_COMBOT_SPOT_INSPECT_OFF		0"
		"		TASK_COMBOT_CLEAR_INSPECT_TARGET	0"
		""
		"	Interrupts"
		"		COND_NEW_ENEMY"
	...
	(
		...
		"	Tasks"
		"		TASK_COMBOT_SET_FLY_ATTACK			0"
		"		TASK_SET_ACTIVITY					ACTIVITY:ACT_COMBOT_IDLE_ALERT"
		"		TASK_WAIT							0.1"
		""
		"	Interrupts"
	...
	(
		...
		"	Tasks"
		"		TASK_COMBOT_SET_FLY_PHOTO			0"
		"		TASK_PLAY_SEQUENCE					ACTIVITY:ACT_COMBOT_IDLE_ALERT"
		"		TASK_COMBOT_PHOTOGRAPH				0"
		""
		"	Interrupts"
		"		COND_COMBOT_INSPECT_DONE"
		"		COND_NEW_ENEMY"
	...
	(
		...
		"		TASK_COMBOT_ATTACK_PRE_FLASH		0 "
		"		TASK_COMBOT_ATTACK_FLASH			0"
		"		TASK_WAIT							0.5"
		""
		"	Interrupts"
		"		COND_NEW_ENEMY"
	...
	(
		...
		"		TASK_COMBOT_ATTACK_PRE_GAS			0"
		"		TASK_COMBOT_ATTACK_GAS				0"
		"		TASK_WAIT							0.5"
		""
		"	Interrupts"
		"		COND_NEW_ENEMY"
	...
	(
		...
		"	Tasks"
		"		 TASK_COMBOT_SET_FLY_CHASE			0"
		"		 TASK_SET_FAIL_SCHEDULE				SCHEDULE:SCHED_COMBOT_PATROL"
