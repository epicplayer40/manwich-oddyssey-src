...
class CNPC_HGang : public CHL1BaseNPC
{
	DECLARE_CLASS( CNPC_HGang, CHL1BaseNPC );
public:
	...
	void FireRocket( Vector &viewDir, int damage, int radius, Vector vecLaunchPoint );
...
public:
	...
	enum
	{
		SCHED_HGANG_FOLLOW = BaseClass::NEXT_SCHEDULE,
		SCHED_HGANG_STOP_FOLLOWING,
		SCHED_HGANG_FACE_TARGET,
	};
