...
//
//=============================================================================//
#ifndef NPC_FHGRUNT_H
#define NPC_FHGRUNT_H

#include "ai_squad.h"
#include "hl1_ai_basenpc.h"

class CNPC_CGrunt : public CHL1BaseNPC
{
	DECLARE_CLASS( CNPC_CGrunt, CHL1BaseNPC );
public:
...
public:
	...
	enum
	{
		SCHED_FHCGRUNT_FOLLOW = BaseClass::NEXT_SCHEDULE,
		SCHED_FHCGRUNT_STOP_FOLLOWING,
