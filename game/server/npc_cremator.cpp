...
//
// Purpose:		The Cremator. Walks around with an immolator and disintegrates and burns things.
//				Don't fuck with him or he'll burn your face off
//				CURRENTLY USING CLASS_COMBINE FOR NOW UNTIL I GET CLASS_CREMATOR IMPLEMENTED
// $NoKeywords: $
//=============================================================================//
...
ConVar	sk_cremator_immolator_beamwidth	("sk_cremator_immolator_beamwidth", "2.0" );
ConVar	sk_cremator_burn_duration ("sk_cremator_burn_duration", "1.5" );
...
void CNPC_Cremator::ImmoBeam( int side )
{
	...
	m_pBeam[m_iBeams] = CBeam::BeamCreate( sk_cremator_immolator_beamsprite.GetString(), sk_cremator_immolator_beamwidth.GetFloat() ); //width is 5.0f by default ); //physbeam default
	...
	{
		CTakeDamageInfo info( this, pEntity, sk_cremator_dmg_immo.GetFloat(), DMG_DISSOLVE ); //dmg_dissolve and dmg_burn by default
		Ignite(100);
		CalculateMeleeDamageForce( &info, vecAim, tr.endpos );
		RadiusDamage( CTakeDamageInfo( this, pEntity, sk_cremator_dmg_immo.GetFloat(), DMG_BURN ), tr.endpos, 128,  CLASS_NONE, NULL ); //changed from 256 to 128 to correspond with noisebeams
...
class CNPC_CrematorAlly : public CNPC_Cremator
{
public:
...
LINK_ENTITY_TO_CLASS( npc_cremator_ally, CNPC_CrematorAlly );


void CNPC_CrematorAlly::Precache(void)
{

    CNPC_Cremator::Precache();
...
void CNPC_CrematorAlly::Spawn( void )
{
    Precache();
...
Class_T    CNPC_CrematorAlly::Classify( void )
{
