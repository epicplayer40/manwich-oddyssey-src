...
ConVar sk_bigmomma_health( "sk_bigmomma_health", "3000" );
...
void CNPC_BigMomma::Spawn()
{
	...
	m_iHealth = sk_bigmomma_health.GetFloat();
...
void CNPC_BigMomma::NodeReach( void )
{
	...
	if ( pTarget->m_iHealth >= 1 )
		 m_iMaxHealth = m_iHealth = pTarget->m_iHealth * sk_bigmomma_health.GetFloat();
...
void CNPC_BigMomma::LayHeadcrab( void )
{
	...
	UTIL_DecalTrace( &tr, "ship_snow1b" );
