...
ConVar sk_hassassin_health( "sk_hassassin_health", "125" );
...
//=========================================================
#define		HASSASSIN_AE_RELOAD	1
#define		ASSASSIN_AE_SHOOT1	3
#define		ASSASSIN_AE_TOSS1	5
#define		ASSASSIN_AE_JUMP	7
...
void CNPC_HAssassin::Spawn()
{
	...
	CapabilitiesAdd( bits_CAP_USE_WEAPONS | bits_CAP_INNATE_RANGE_ATTACK2 | bits_CAP_INNATE_MELEE_ATTACK1 );
...
void CNPC_HAssassin::Precache()
{
	...
	PrecacheModel("models/gascit.mdl");
