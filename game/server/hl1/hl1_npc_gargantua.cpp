...
#define GARG_DAMAGE					( DMG_ENERGYBEAM | DMG_CRUSH | DMG_MISSILEDEFENSE | DMG_BLAST | DMG_BULLET | DMG_BUCKSHOT | DMG_SHOCK | DMG_BURN )
#define GARG_EYE_SPRITE_NAME		"sprites/redglow1.vmt"
#define GARG_BEAM_SPRITE_NAME		"sprites/plasma.vmt"
#define GARG_BEAM_SPRITE2			"sprites/plasma.vmt"
#define GARG_STOMP_SPRITE_NAME		"sprites/redglow1.vmt"
...
ConVar sk_gargantua_health ( "sk_gargantua_health", "2000" );
...
void CNPC_Gargantua::FlameUpdate( void )
{
	...
	for ( i = 0; i < 2; i++ )
	{
		if ( m_pFlame[i] )
		{
			...
			// RadiusDamage( trace.vecEndPos, pev, pev, gSkillData.gargantuaDmgFire, CLASS_ANTLION, DMG_BURN );
			FlameDamage( vecStart, trace.endpos, this, this, sk_gargantua_dmg_fire.GetFloat(), CLASS_ANTLION, DMG_BURN );
