...
//
// Purpose: Martian Civilians. When they aren't being used as target practice by the many gangs on mars they're either running and hiding or taking up arms against them 
//
// $Workfile:     $
// $Date:         $
//
...
//TODO:
//Make a version that has a chance of throwing molotovs at hostiles, then runs away and hides after throwing and plants a few mines to cover his escape (not yet implemented)
//walk around instead of standing in the same spot while idle (tried, failed. They won't go back to wandering when returning to idle so I reverted it. smh)
//Chance to run around when panicked instead of staying in the same spot
...
ConVar	sk_scientist_health( "sk_scientist_health","30");
ConVar	sk_scientist_heal( "sk_scientist_heal","80");
...
#define		SCIENTIST_AE_THROWMOLOTOV	( 4 )
...
void CNPC_Scientist::Precache( void )
{
	...
	PrecacheModel( "models/scientist02.mdl" );
	PrecacheModel( "models/scientist03.mdl" );
	PrecacheModel( "models/scientist04.mdl" );
	PrecacheModel( "models/scientist05.mdl" );
...
void CNPC_Scientist::Spawn( void )
{
	...
	*/
	...
	{
		SetModel( "models/scientist02.mdl" );
	}
	else if (r == 3)
	{
		SetModel( "models/scientist03.mdl" );
	}
	else if (r == 4)
	{
		SetModel( "models/scientist04.mdl" );
	}
	else if (r == 5)
	{
		SetModel( "models/scientist05.mdl" );
	}*/
