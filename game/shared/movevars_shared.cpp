...
ConVar	sv_maxvelocity	( "sv_maxvelocity","10000", FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Maximum speed any ballistically moving object is allowed to attain per axis." );
...
ConVar	sv_rollangle	( "sv_rollangle", "2.5", FCVAR_NOTIFY | FCVAR_REPLICATED, "Max view roll angle");
