...
void CMortarShell::Impact( void )
{
	...
	//Tankmorter is DMG_BLAST|DMG_DISSOLVE by default. Changed to just DMG_BLAST
	RadiusDamage( CTakeDamageInfo( this, GetOwnerEntity(), MORTAR_BLAST_DAMAGE, (DMG_BLAST) ), GetAbsOrigin(), MORTAR_BLAST_RADIUS, CLASS_NONE, NULL );
