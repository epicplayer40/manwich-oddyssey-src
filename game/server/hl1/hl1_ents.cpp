...
class CXenPLight : public CAI_BaseNPC
{
	DECLARE_CLASS( CXenPLight, CAI_BaseNPC );
...
class CXenHair : public CAI_BaseNPC
{
	DECLARE_CLASS( CXenHair, CAI_BaseNPC );
public:
	void		Spawn( void );
	void		Precache( void );
	void		Think( void );
...
class CXenSpore : public CAI_BaseNPC
{
	DECLARE_CLASS( CXenSpore, CAI_BaseNPC );
public:
	void		Spawn( void );
	void		Precache( void );
	void		Touch( CBaseEntity *pOther );
