...
int	CHalfLife1::Damage_GetShowOnHud( void )
{
	...
	void CHalfLife1::InitDefaultAIRelationships( void )
	{
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_PLAYER,			D_LI, 0 );	
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_CITIZEN_PASSIVE,	D_LI, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_PLAYER_ALLY,		D_LI, 0 );	
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_ALIEN_PREY,		D_FR, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_MILITARY,	D_FR, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_ANTLION,	D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_ANTLION,	D_FR, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CITIZEN_PASSIVE,		CLASS_CONSCRIPT,	D_HT, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_PLAYER_ALLY,		CLASS_CITIZEN_PASSIVE,	D_LI, 0 );	
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_PLAYER_ALLY,		CLASS_ANTLION,	D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_PLAYER_ALLY,		CLASS_CONSCRIPT,	D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_PLAYER_ALLY,		CLASS_MACHINE,			D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_PLAYER_ALLY,		CLASS_MILITARY,	D_NU, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ALIEN_PREY,			CLASS_ANTLION,	D_FR, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,		CLASS_ALIEN_PREY,		D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,		CLASS_MILITARY,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,		CLASS_ANTLION,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,		CLASS_ANTLION,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,		CLASS_CONSCRIPT,	D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,		CLASS_MACHINE,			D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,		CLASS_MILITARY,	D_NU, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_ALIEN_PREY,		D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_MILITARY,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_ANTLION,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_ANTLION,	D_NU, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_MILITARY,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_PLAYER_BIOWEAPON,	D_NU, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_ANTLION,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_CONSCRIPT,	D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_MACHINE,			D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_MILITARY,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_PLAYER_BIOWEAPON,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_ANTLION,		CLASS_INSECT,			D_NU, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CONSCRIPT,		CLASS_PLAYER_ALLY,		D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CONSCRIPT,		CLASS_CITIZEN_PASSIVE,	D_HT, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_CONSCRIPT,		CLASS_MILITARY,	D_NU, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MACHINE,			CLASS_MILITARY,	D_HT, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,	CLASS_PLAYER_ALLY,		D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,	CLASS_MILITARY,	D_NU, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,	CLASS_PLAYER_BIOWEAPON,	D_HT, 0 );
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_MILITARY,	CLASS_INSECT,			D_NU, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_PLAYER_BIOWEAPON,	CLASS_MILITARY,	D_HT, 0 );
		...
		CBaseCombatCharacter::SetDefaultRelationship( CLASS_INSECT,				CLASS_CONSCRIPT,	D_FR, 0 );
