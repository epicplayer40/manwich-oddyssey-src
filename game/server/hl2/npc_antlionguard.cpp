...
ConVar	sk_crabsynth_health( "sk_crabsynth_health", "750" );
...
Class_T	CNPC_AntlionGuard::Classify(void)
{
	if (FClassnameIs(this, "npc_crabsynth"))
	{
...
LINK_ENTITY_TO_CLASS( npc_crabsynth, CNPC_AntlionGuard );
