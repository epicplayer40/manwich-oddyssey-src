...
void CNPC_Conscript::InitCustomSchedules(void) 
{
	...
	AI_LOAD_SCHEDULE(CNPC_Conscript,	SCHED_CONSCRIPT_CAUTIOUS_TAKECOVER);
}
...
(
	...
	"	TASK_WAIT_FOR_MOVEMENT		0"
    "   TASK_RANGE_ATTACK1  0"
    "   TASK_WAIT_FACE_ENEMY_RANDOM   0.15"
    "   TASK_RANGE_ATTACK1  0"
    "   TASK_WAIT_FACE_ENEMY_RANDOM    0.15"
    "   TASK_RANGE_ATTACK1  0"
    "   TASK_WAIT_FACE_ENEMY_RANDOM   0.15"
	"	TASK_FIND_FAR_NODE_COVER_FROM_ENEMY 1024"
	"	TASK_RUN_PATH				0"
	"	TASK_WAIT_FOR_MOVEMENT		0"
	"	TASK_PLAY_SEQUENCE	ACTIVITY:ACT_COVER_MED"
	""
    "   Interrupts"
    "       COND_WEAPON_BLOCKED_BY_FRIEND"
     "      COND_ENEMY_DEAD"
